...
const deleteCountry = async id => {
    const result = await pool.query('update countries set deleted = 1 where id = $1 returning *', [id])
    return new SuccessResult(DATA_DELETED_SUCCESSFULLY, result.rows[0])
}
